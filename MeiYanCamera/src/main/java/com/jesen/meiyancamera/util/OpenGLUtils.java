package com.jesen.meiyancamera.util;
...
public class OpenGLUtils {
    ...
    public static String readRawFile(Context context, int rewId) {
        InputStream is = context.getResources().openRawResource(rewId);
